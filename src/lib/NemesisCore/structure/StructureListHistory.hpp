#ifndef StructureListHistoryH
#define StructureListHistoryH
// =============================================================================
...
class CSetActiveStructureHI: public CHistoryItem {
public:
// constructors and destructors ------------------------------------------------
    CSetActiveStructureHI(CProject* p_object);
    CSetActiveStructureHI(CStructureList* p_sl,
                               CStructure* p_prev,CStructure* p_next,
                               EHistoryItemDirection change);

// section of private data -----------------------------------------------------
private:
    int PrevStructureIndex;
