#ifndef StructureListDesignerH
#define StructureListDesignerH
// =============================================================================
...
#include "ui_StructureListDesigner.h"
...
class CStructureListDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CStructureListDesigner(CStructureList* p_owner);
...
private:
    CStructureList*             List;
    Ui::StructureListDesigner   WidgetUI;
