#ifndef MolManipMouseDriverH
#define MolManipMouseDriverH
// =============================================================================
...
class NEMESIS_CORE_PACKAGE CMolManipMouseDriver :
                                public CMouseDriver, public CObjectManipulator {
Q_OBJECT
public:
// constructors and destructors -----------------------------------------------
    CMolManipMouseDriver(CMouseHandler* p_handler);
    ~CMolManipMouseDriver(void);
