#ifndef DirManipMouseDriverH
#define DirManipMouseDriverH
// =============================================================================
...
class NEMESIS_CORE_PACKAGE CDirManipMouseDriver :
                                public CMouseDriver, public CObjectManipulator {
Q_OBJECT
public:
// constructors and destructors -----------------------------------------------
    CDirManipMouseDriver(CMouseHandler* p_handler);
    ~CDirManipMouseDriver(void);
