#ifndef RestraintListSelectionH
#define RestraintListSelectionH
// =============================================================================
...
/// select list of restraints

class NEMESIS_CORE_PACKAGE CRestraintListSelection : public CSelectionHandler {
public:
// handler main method -----------------------------------------------------
...
extern CRestraintListSelection NEMESIS_CORE_PACKAGE SH_RestraintList;
