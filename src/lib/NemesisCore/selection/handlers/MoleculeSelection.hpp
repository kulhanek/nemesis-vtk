#ifndef MoleculeSelectionH
#define MoleculeSelectionH
// =============================================================================
...
class NEMESIS_CORE_PACKAGE CMoleculeSelection : public CSelectionHandler {
public:
// handler main method -----------------------------------------------------
...
extern CMoleculeSelection NEMESIS_CORE_PACKAGE SH_Molecule;
