#ifndef ResidueSelectionH
#define ResidueSelectionH
// =============================================================================
...
class NEMESIS_CORE_PACKAGE CResidueSelection : public CSelectionHandler {
public:
// handler main method -----------------------------------------------------
...
extern CResidueSelection NEMESIS_CORE_PACKAGE SH_Residue;
