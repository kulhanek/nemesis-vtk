#ifndef ResidueListSelectionH
#define ResidueListSelectionH
// =============================================================================
...
/// select list of residues

class NEMESIS_CORE_PACKAGE CResidueListSelection : public CSelectionHandler {
public:
// handler main method -----------------------------------------------------
...
extern CResidueListSelection NEMESIS_CORE_PACKAGE SH_ResidueList;
