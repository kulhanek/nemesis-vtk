#ifndef AtomListSelectionH
#define AtomListSelectionH
// =============================================================================
...
class NEMESIS_CORE_PACKAGE CAtomListSelection : public CSelectionHandler {
public:
// handler main method -----------------------------------------------------
...
extern CAtomListSelection NEMESIS_CORE_PACKAGE SH_AtomList;
