#ifndef StructureListSelectionH
#define StructureListSelectionH
// =============================================================================
...
/// select list of structures

class NEMESIS_CORE_PACKAGE CStructureListSelection : public CSelectionHandler {
public:
// handler main method -----------------------------------------------------
...
extern CStructureListSelection NEMESIS_CORE_PACKAGE SH_StructureList;
