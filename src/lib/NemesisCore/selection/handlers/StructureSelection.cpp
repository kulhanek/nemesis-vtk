...
CStructureSelection SH_Structure;

//==============================================================================
//------------------------------------------------------------------------------
//==============================================================================

const QString CStructureSelection::GetHandlerDescription(void) const
{
...
ESelResult CStructureSelection::RegisterObject(CSelectionList* p_sel,const CSelObject& obj)
{
