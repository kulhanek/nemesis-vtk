#ifndef CombPhysicalQuantityH
#define CombPhysicalQuantityH
// =============================================================================
...
/// implementation of combined physical quantity

class NEMESIS_CORE_PACKAGE CCombPhysicalQuantity : public CPhysicalQuantity {
    Q_OBJECT
public:
// constructors and destructors -----------------------------------------------
    CCombPhysicalQuantity(CExtComObject* p_parent,
...
private:
    CPhysicalQuantity*      LeftPQ;
    CPhysicalQuantity*      RightPQ;
    ECombPhysicalQuantityOp Operation;
