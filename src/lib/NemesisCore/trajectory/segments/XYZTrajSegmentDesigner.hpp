#ifndef XYZTrajSegmentDesignerH
#define XYZTrajSegmentDesignerH
// =============================================================================
...
#include "ui_XYZTrajSegmentDesigner.h"

//------------------------------------------------------------------------------

class CXYZTrajSegment;
...
class CXYZTrajSegmentDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CXYZTrajSegmentDesigner(CXYZTrajSegment* p_owner);
...
private:
    CXYZTrajSegment*            Object;
    Ui::XYZTrajSegmentDesigner  WidgetUI;
