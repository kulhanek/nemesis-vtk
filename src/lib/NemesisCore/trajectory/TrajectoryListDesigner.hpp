#ifndef TrajectoryListDesignerH
#define TrajectoryListDesignerH
// =============================================================================
...
#include "ui_TrajectoryListDesigner.h"

//------------------------------------------------------------------------------

class CTrajectoryList;
class CPODesignerGeneral;
class CPODesignerTrajectories;

//------------------------------------------------------------------------------

class CTrajectoryListDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CTrajectoryListDesigner(CTrajectoryList* p_owner);
...
private:
    ...
    Ui::TrajectoryListDesigner  WidgetUI;
    CPODesignerGeneral*         General;
    CPODesignerTrajectories*    Trajectories;
