#ifndef NemesisStyleH
#define NemesisStyleH
// =============================================================================
...
class NEMESIS_CORE_PACKAGE CNemesisStyle : public QProxyStyle {
public:
// constructors and destructors -----------------------------------------------
    CNemesisStyle(void);

    /// redeine pixel metric
    virtual int pixelMetric(QStyle::PixelMetric metric, const QStyleOption* option,
