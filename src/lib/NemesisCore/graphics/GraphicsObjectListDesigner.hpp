#ifndef GraphicsObjectListDesignerH
#define GraphicsObjectListDesignerH
// =============================================================================
...
#include "ui_GraphicsObjectListDesigner.h"
...
/// graphics object list designer

class CGraphicsObjectListDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CGraphicsObjectListDesigner(CGraphicsObjectList* p_gp);
...
private:
    Ui::GraphicsObjectListDesigner      WidgetUI;
    CGraphicsObjectList*                Object;
    CPODesignerGeneral*                 General;
    CContainerModel*                    ObjectModel;

private slots:
    void ObjectTVSelectionChnaged(void);
