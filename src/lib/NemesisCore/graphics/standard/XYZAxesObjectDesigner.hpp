#ifndef XYZAxesObjectDesignerH
#define XYZAxesObjectDesignerH
// =============================================================================
...
#include "ui_XYZAxesObjectDesigner.h"
...
class CXYZAxesObjectDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor --------------------------------------------------
    CXYZAxesObjectDesigner(CGraphicsObject* p_go);
...
private:
    Ui::XYZAxesObjectDesigner   WidgetUI;
