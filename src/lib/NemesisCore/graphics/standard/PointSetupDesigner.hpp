#ifndef PointSetupDesignerH
#define PointSetupDesignerH
// =============================================================================
...
#include "ui_PointSetupDesigner.h"
...
class CPointSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CPointSetupDesigner(CPointSetup* p_setup);
...
private:
    Ui::PointSetupDesigner  WidgetUI;
    CPointSetup*            Setup;
