#ifndef AtomLabelSetupDesignerH
#define AtomLabelSetupDesignerH
...
#include "ui_AtomLabelSetupDesigner.h"
...
class CAtomLabelSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CAtomLabelSetupDesigner(CAtomLabelSetup* p_setup);
...
private:
    Ui::AtomLabelSetupDesigner  WidgetUI;
    CAtomLabelSetup*            Setup;
