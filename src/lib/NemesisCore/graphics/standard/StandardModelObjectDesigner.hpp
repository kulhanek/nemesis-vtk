#ifndef StandardModelObjectDesignerH
#define StandardModelObjectDesignerH
// =============================================================================
...
#include "ui_StandardModelObjectDesigner.h"
...
class CStandardModelObjectDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CStandardModelObjectDesigner(CStandardModelObject* p_bo);
...
private:
    Ui::StandardModelObjectDesigner WidgetUI;
    CStandardModelObject*           Object;
