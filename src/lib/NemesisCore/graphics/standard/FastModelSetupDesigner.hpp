#ifndef FastModelSetupDesignerH
#define FastModelSetupDesignerH
// =============================================================================
...
#include "ui_FastModelSetupDesigner.h"
...
class CFastModelSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CFastModelSetupDesigner(CFastModelSetup* p_bo);
...
private:
    Ui::FastModelSetupDesigner  WidgetUI;
    CFastModelSetup*            Setup;
