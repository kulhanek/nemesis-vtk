#ifndef LightObjectDesignerH
#define LightObjectDesignerH
// =============================================================================
...
#include "ui_LightObjectDesigner.h"
...
class CLightObjectDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CLightObjectDesigner(CLightObject* p_bo);
...
private:
    Ui::LightObjectDesigner WidgetUI;
    CLightObject*           Object;
