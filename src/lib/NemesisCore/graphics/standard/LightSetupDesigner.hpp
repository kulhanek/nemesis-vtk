#ifndef LightSetupDesignerH
#define LightSetupDesignerH
// =============================================================================
...
#include "ui_LightSetupDesigner.h"
...
class CLightSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CLightSetupDesigner(CLightSetup* p_bo);
...
private:
    Ui::LightSetupDesigner  WidgetUI;
    CLightSetup*            Setup;
