#ifndef AtomLabelObjectDesignerH
#define AtomLabelObjectDesignerH
// =============================================================================
...
#include "ui_AtomLabelObjectDesigner.h"
...
class CAtomLabelObjectDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CAtomLabelObjectDesigner(CAtomLabelObject* p_bo);
...
private:
    Ui::AtomLabelObjectDesigner WidgetUI;
    CAtomLabelObject*           Object;
...
private slots:
    ...
    void CustomFormatClicked(bool checked);
