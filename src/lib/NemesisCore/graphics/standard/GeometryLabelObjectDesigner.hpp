#ifndef GeometryLabelObjectDesignerH
#define GeometryLabelObjectDesignerH
// =============================================================================
...
#include "ui_GeometryLabelObjectDesigner.h"
...
class CGeometryLabelObjectDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor --------------------------------------------------
    CGeometryLabelObjectDesigner(CGeometryLabelObject* p_go);
...
private:
    Ui::GeometryLabelObjectDesigner WidgetUI;
    CGeometryLabelObject*           Object;
