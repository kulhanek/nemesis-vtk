#ifndef PlaneObjectDesignerH
#define PlaneObjectDesignerH
// =============================================================================
...
#include "ui_PlaneObjectDesigner.h"
...
class CPlaneObjectDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor --------------------------------------------------
    CPlaneObjectDesigner(CPlaneObject* p_go);
...
private:
    Ui::PlaneObjectDesigner     WidgetUI;
    CPlaneObject*               Object;
