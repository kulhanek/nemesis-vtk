#ifndef TextSetupDesignerH
#define TextSetupDesignerH
...
#include "ui_TextSetupDesigner.h"
...
class CTextSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CTextSetupDesigner(CTextSetup* p_setup);
