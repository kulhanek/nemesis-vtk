#ifndef GeometryLabelSetupDesignerH
#define GeometryLabelSetupDesignerH
...
#include "ui_GeometryLabelSetupDesigner.h"
...
class CGeometryLabelSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CGeometryLabelSetupDesigner(CGeometryLabelSetup* p_setup);
...
private:
    Ui::GeometryLabelSetupDesigner  WidgetUI;
