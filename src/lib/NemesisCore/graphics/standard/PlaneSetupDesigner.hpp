#ifndef PlaneSetupDesignerH
#define PlaneSetupDesignerH
...
#include "ui_PlaneSetupDesigner.h"
...
class CPlaneSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CPlaneSetupDesigner(CPlaneSetup* p_setup);
...
private:
    Ui::PlaneSetupDesigner  WidgetUI;
    CPlaneSetup*            Setup;
