#ifndef VectorSetupDesignerH
#define VectorSetupDesignerH
...
#include "ui_VectorSetupDesigner.h"
...
class CVectorSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CVectorSetupDesigner(CVectorSetup* p_setup);
...
private:
    Ui::VectorSetupDesigner WidgetUI;
    CVectorSetup*           Setup;
