#ifndef TextObjectDesignerH
#define TextObjectDesignerH
// =============================================================================
...
#include "ui_TextObjectDesigner.h"
...
class CTextObjectDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CTextObjectDesigner(CTextObject* p_bo);
...
private:
    Ui::TextObjectDesigner  WidgetUI;
    CTextObject*            Object;
