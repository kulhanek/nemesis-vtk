#ifndef SpecAxesSetupDesignerH
#define SpecAxesSetupDesignerH
// =============================================================================
...
#include "ui_SpecAxesSetupDesigner.h"
...
/// special axes setup designer

class CSpecAxesSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CSpecAxesSetupDesigner(CSpecAxesSetup* p_bo);
...
private:
    Ui::SpecAxesSetupDesigner    WidgetUI;
