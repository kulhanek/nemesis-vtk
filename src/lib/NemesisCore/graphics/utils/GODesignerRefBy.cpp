...
#include "GODesignerRefBy.moc"

//==============================================================================
//------------------------------------------------------------------------------
//==============================================================================

CGODesignerRefBy::CGODesignerRefBy(QWidget* p_owner,CGraphicsObject* p_object,
...
void CGODesignerRefBy::InitValues(void)
{
    // nothing to do here
}
...
void CGODesignerRefBy::ObjectTVDblClicked(const QModelIndex& index)
{
