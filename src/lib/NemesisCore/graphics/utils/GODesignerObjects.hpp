#ifndef GODesignerObjectsH
#define GODesignerObjectsH
// =============================================================================
...
#include <QWidget>
#include "ui_GODesignerObjects.h"
...
class NEMESIS_CORE_PACKAGE CGODesignerObjects : public QWidget {
Q_OBJECT
public:
// constructor and destructor --------------------------------------------------
    CGODesignerObjects(QWidget* p_owner,CGraphicsObject* p_object,CProObjectDesigner* p_designer);
...
private slots:
    ...
    void AddStructureObject(void);
    void AddAllStructures(void);
    void AddSelectedObjects(void);
