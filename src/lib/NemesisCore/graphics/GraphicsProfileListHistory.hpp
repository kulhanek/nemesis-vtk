#ifndef GraphicsProfileListHistoryH
#define GraphicsProfileListHistoryH
// =============================================================================
...
class CSetActiveProfileHI: public CHistoryItem {
public:
// constructors and destructors ------------------------------------------------
    CSetActiveProfileHI(CProject *p_object);
    CSetActiveProfileHI(CGraphicsProfileList* p_gp,
