#ifndef GeoPropertySetupDesignerH
#define GeoPropertySetupDesignerH
...
#include "ui_GeoPropertySetupDesigner.h"
...
class NEMESIS_CORE_PACKAGE CGeoPropertySetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CGeoPropertySetupDesigner(CGeoPropertySetup* p_setup);
...
private:
    Ui::GeoPropertySetupDesigner  WidgetUI;
