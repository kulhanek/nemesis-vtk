#ifndef DistancePropertyDesignerH
#define DistancePropertyDesignerH
// =============================================================================
...
#include "ui_DistancePropertyDesigner.h"
#include <ProObject.hpp>

//------------------------------------------------------------------------------

class CDistanceProperty;
...
class CDistancePropertyDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CDistancePropertyDesigner(CDistanceProperty* p_bo);
...
private:
    Ui::DistancePropertyDesigner    WidgetUI;
    CDistanceProperty*              Object;
