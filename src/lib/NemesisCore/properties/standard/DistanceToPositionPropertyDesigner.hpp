#ifndef DistanceToPositionPropertyDesignerH
#define DistanceToPositionPropertyDesignerH
// =============================================================================
...
#include "ui_DistanceToPositionPropertyDesigner.h"
...
class CDistanceToPositionPropertyDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CDistanceToPositionPropertyDesigner(CDistanceToPositionProperty* p_bo);
...
private:
    Ui::DistanceToPositionPropertyDesigner  WidgetUI;
    CDistanceToPositionProperty*            Object;
