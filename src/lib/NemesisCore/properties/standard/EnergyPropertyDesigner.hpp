#ifndef EnergyPropertyDesignerH
#define EnergyPropertyDesignerH
// =============================================================================
...
#include "ui_EnergyPropertyDesigner.h"
...
class CEnergyPropertyDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CEnergyPropertyDesigner(CEnergyProperty* p_bo);
...
private:
    Ui::EnergyPropertyDesigner  WidgetUI;
    CEnergyProperty*            Object;
