#ifndef TorsionPropertyDesignerH
#define TorsionPropertyDesignerH
// =============================================================================
...
#include "ui_TorsionPropertyDesigner.h"
#include <ProObject.hpp>

//------------------------------------------------------------------------------

class CTorsionProperty;
...
class CTorsionPropertyDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CTorsionPropertyDesigner(CTorsionProperty* p_bo);
...
private:
    Ui::TorsionPropertyDesigner WidgetUI;
    CTorsionProperty*           Object;
