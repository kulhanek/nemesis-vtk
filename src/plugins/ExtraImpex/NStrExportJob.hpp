#ifndef NStrExportJobH
#define NStrExportJobH
// =============================================================================
...
class CNStrExportJob : public CJob {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CNStrExportJob(CStructure* p_mol,const QString& name);

// section of private data ----------------------------------------------------
private:
    CStructure*         Structure;
    QString             FileName;
    CXMLDocument        OutputDoc;
    CLockLevels         BackupLockLevels;
    CIndexCounter       Indexes;
