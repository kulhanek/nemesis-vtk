#ifndef ChargesImportJobH
#define ChargesImportJobH
// =============================================================================
...
/// point charges import job

class CChargesImportJob : public CImportJob {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CChargesImportJob(CProject* p_project);
...
signals:
    ...
    friend class CChargesImportTool;
};
