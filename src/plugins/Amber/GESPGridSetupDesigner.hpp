#ifndef GESPGridSetupDesignerH
#define GESPGridSetupDesignerH
// =============================================================================
...
#include "ui_GESPGridSetupDesigner.h"
...
class CGESPGridSetupDesigner : public CProObjectDesigner {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CGESPGridSetupDesigner(CGESPGridSetup* p_setup);
...
private:
    Ui::GESPGridSetupDesigner   WidgetUI;
    CGESPGridSetup*             Setup;
