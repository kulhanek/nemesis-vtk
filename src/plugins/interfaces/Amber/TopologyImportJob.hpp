#ifndef TopologyImportJobH
#define TopologyImportJobH
// =============================================================================
...
/// amber topology import job

class CTopologyImportJob : public CImportJob {
Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CTopologyImportJob(CProject* p_project);
...
signals:
    ...
    friend class CTopologyImportTool;
};
