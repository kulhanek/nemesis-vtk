#ifndef PdbqtExportJobH
#define PdbqtExportJobH
// =============================================================================
...
class CPdbqtExportJob : public CJob {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CPdbqtExportJob(CStructure* p_mol,const QString& name);
...
private:
    ...
    std::map<CAtom*,int>    MoleculeIndexes;
    std::map<QString,QString>    PDBQTTypes;
    int                     MaxTicks;
    int                     Quantum;
    int                     Tick;
    ...
    void InitMoleculeIndexes(CStructure* p_mol);
    QString GetPDBQTSymbol(const CAtom* p_atom);
