...
#include "DockingProjectLigandExportJob.moc"
...
QObject* DockingProjectLigandExportJobCB(void* p_data);

CExtUUID        DockingProjectLigandExportJobID(
                    "{DOCKING_PROJECT_LIGAND_EXPORT_JOB:98e76612-e7ac-4d1b-9e29-b7a742cd046f}",
                    "PDBQT Ligand Export");

CPluginObject   DockingProjectLigandExportJobObject(&DockingProjectPlugin,
                    DockingProjectLigandExportJobID,JOB_CAT,
                    NULL);
...
CDockingProjectLigandExportJob::CDockingProjectLigandExportJob(CStructure* p_mol, const QString& name, bool flexible, bool combine, bool renumber)
    : CJob(&DockingProjectLigandExportJobObject,p_mol->GetProject())
{
    Structure = p_mol;
    FileName = name;
    Flexible = flexible;
...
bool CDockingProjectLigandExportJob::JobAboutToBeSubmitted(void)
{
...
bool CDockingProjectLigandExportJob::InitializeJob(void)
{
...
bool CDockingProjectLigandExportJob::ExecuteJob(void)
{
    Tick = 1;
...
bool CDockingProjectLigandExportJob::FinalizeJob(void)
{
    // close file
    sout.close();
