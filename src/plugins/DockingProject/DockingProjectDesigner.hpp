#ifndef DockingProjectDesignerH
#define DockingProjectDesignerH
// =============================================================================
...
#include "ui_DockingProjectDesigner.h"
...
class CDockingProjectDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CDockingProjectDesigner(CDockingProject* p_owner);
...
private:
    ...
    Ui::DockingProjectDesigner    WidgetUI;
