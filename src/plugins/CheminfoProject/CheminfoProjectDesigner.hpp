#ifndef CheminfoProjectDesignerH
#define CheminfoProjectDesignerH
// =============================================================================
...
#include "ui_CheminfoProjectDesigner.h"
...
class CCheminfoProjectDesigner : public CProObjectDesigner {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CCheminfoProjectDesigner(CCheminfoProject* p_owner);
...
private:
    ...
    Ui::CheminfoProjectDesigner    WidgetUI;
    CPODesignerGeneral*            General;
    CPODesignerCheminfoProjectInfoList*   ProjectInfoList;
