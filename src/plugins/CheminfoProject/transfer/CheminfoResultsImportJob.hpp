#ifndef CheminfoResultsImportJobH
#define CheminfoResultsImportJobH
// =============================================================================
...
class CCheminfoResultsImportJob : public CImportJob {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CCheminfoResultsImportJob(CProject* p_project);
