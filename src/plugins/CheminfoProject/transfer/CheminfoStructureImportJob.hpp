#ifndef CheminfoStructureImportJobH
#define CheminfoStructureImportJobH
// =============================================================================
...
class CCheminfoStructureImportJob : public CImportJob {
    Q_OBJECT
public:
// constructor and destructor -------------------------------------------------
    CCheminfoStructureImportJob(CProject* p_project);
