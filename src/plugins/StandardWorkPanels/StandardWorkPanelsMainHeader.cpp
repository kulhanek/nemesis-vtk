...
#include "StandardWorkPanelsMainHeader.hpp"
...
// declare entry point
extern "C" void __standard_work_panels_main(void) __attribute__ ((noreturn));

// define entry point
extern "C" void __standard_work_panels_main(void)
{
    printf("Standard Work Panels Plugin\n");
    _exit(0);
}
