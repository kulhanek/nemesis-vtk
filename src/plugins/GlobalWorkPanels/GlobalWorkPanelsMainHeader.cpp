...
#include "GlobalWorkPanelsMainHeader.hpp"
...
// declare entry point
extern "C" void __admin_work_panels_main(void) __attribute__ ((noreturn));

// define entry point
extern "C" void __admin_work_panels_main(void)
{
    printf("Admin Work Panels Plugin\n");
    _exit(0);
}
